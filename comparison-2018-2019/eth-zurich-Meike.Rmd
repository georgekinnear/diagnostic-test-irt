...
# load data
eth_2018 <- read_csv(here::here("comparison-2018-2019", "data/2018-q32/all-2018.csv"))
eth_2019 <- read_csv(here::here("comparison-2018-2019", "data/2019-q32/all-2019.csv"))
...
plot(fit_2pl_2019, type = "info")
plot(fit_2pl_2018, type = "info")
